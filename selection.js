const Selection = (function () {
  ...
  function _selection() {
    ...
    function twitterButton() {
      ...
      const twbtn = new Button(twitterConfig.icon, twitterConfig.tooltip, function () {
    ...
    function searchButton() {
      const searchbtn = new Button(searchConfig.icon, searchConfig.tooltip, function () {
    ...
    function copyButton() {
      const cbtn = new Button(copyConfig.icon, copyConfig.tooltip, function () {
    ...
    function speakButton() {
      const spbtn = new Button(speakConfig.icon, speakConfig.tooltip, function () {
    ...
    function translateButton() {
      const tsbtn = new Button(translateConfig.icon, translateConfig.tooltip, function () {
